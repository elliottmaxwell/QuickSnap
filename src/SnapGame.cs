...
namespace CardGames
{
    public class SnapGame
    {
        public static void LoadResources()
        {
            ...
            SwinGame.LoadFontNamed ("GameFont", "Chunkfive.otf", 12); //Step 27
        }
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
				SwinGame.DrawText ("Top Card is " + top.ToString (), Color.RoyalBlue, "GameFont", 0, 20); //Step 28
				SwinGame.DrawText ("Player 1 score: " + myGame.Score(0), Color.RoyalBlue, "GameFont", 0, 30); //Step 28
				SwinGame.DrawText ("Player 2 score: " + myGame.Score(1), Color.RoyalBlue, "GameFont", 0, 40); //Step 28
				SwinGame.DrawCell (SwinGame.BitmapNamed ("Cards"), top.CardIndex, 350, 50);
			}
			else
			{
				SwinGame.DrawText ("No card played yet...", Color.RoyalBlue, "GameFont", 0, 20);
			}
